...
def main():
    ...
    df = pd.DataFrame([{"Source": r"C:\Users\HP\Desktop\ROPDetectionAIML\data\images\2-4_25Nov\set 2\Input\6060V2\11.jpg", "ROP Label": 1}])
    
    #df = pd.read_csv(CSV_PATH)

    # Keep only label_1 images
    #df = df[df["ROP Label"] == 1]
    ...
    # Run on first N images only
    #N = 10
    #df = df.sample(N, random_state=42) # reporducibility
    #df = df.sample(N)
